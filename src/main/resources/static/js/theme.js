...
var THEME_CONFIG  = {
  orange: {
    ...
    '--sider-memu-p': 'rgb(81, 90, 110)',
    '--sider-memu-p-hover': 'var(--orange)',
    '--sider-memu-icon-bg': 'linear-gradient(-45deg, rgb(255, 242, 234), rgb(255, 234, 217))',
    '--sider-memu-icon-filter': 'grayscale(1)',
  ...
  blue: {
    ...
    '--sider-memu-p': 'rgb(81, 90, 110)',
    '--sider-memu-p-hover': 'var(--theme-blue)',
  ...
  dark: {
    ...
    '--sider-memu-background': 'rgb(46,46,46)',
    '--sider-memu-p': 'rgb(235, 235, 235)',
    '--sider-memu-p-hover': 'rgb(90, 90, 90)',
    '--sider-memu-icon-bg': 'rgba(88, 88, 88, .7)',
    '--sider-memu-icon-filter': 'grayscale(1) brightness(1.1)',
    '--sider-memu-title-background': 'rgb(58, 58, 58)',
    '--sider-memu-item-border-top': 'rgb(130,130,130)',
    '--sider-memu-item-border-bottom': 'rgb(190, 190, 190)',

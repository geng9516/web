...
/**
 * 年休付与区分判定(常勤通常付与)
 * TMG_F_GET_INVEST_TYPE_T_IYAKU
 */
@Service
@RequiredArgsConstructor(onConstructor = @__(@Autowired))
class TmgGetInvestTypeTIyaku extends BaseExecute {
    ...
    protected Object init(String customerId, String companyId, String employeeId, Date yyyymmdd, Date beginDateWork) {
        ...
        //非常勤通常付与年休ルールを取得
        int  nenkyu =  iMastGenericDetailService.selectNenkyuRuleT(customerId, companyId, employeeId, yyyymmdd, beginDateWork);

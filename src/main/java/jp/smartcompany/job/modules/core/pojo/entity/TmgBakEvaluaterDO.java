...
@TableName("tmg_bak_evaluater")
public class TmgBakEvaluaterDO implements Serializable {
...
private static final long serialVersionUID=1L;
         ...
         * 作成日
         */
    @TableField("tev_dcreate")
        private Date tevDcreate;

        /**
         * 顧客コード 固定：01
         */
    @TableId(value="tev_ccustomerid",type = IdType.INPUT)

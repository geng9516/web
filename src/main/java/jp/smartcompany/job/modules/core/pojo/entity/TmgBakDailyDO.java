...
@TableName("tmg_bak_daily")
public class TmgBakDailyDO implements Serializable {
...
private static final long serialVersionUID=1L;
         ...
         * 作成日
         */
    @TableField("tda_dcreate")
        private Date tdaDcreate;

        /**
         * 顧客ｺｰﾄﾞ固定：01
         */
    @TableId(value="tda_ccustomerid",type = IdType.INPUT)
    ...
    @TableField("tda_dmodifieddate_r")
        ...
        /**
         * [実績]部分休業メッセージ 勤怠登録画面の｢備考｣表示用。tmg_bak_daily_detai
         */

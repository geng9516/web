...
@TableName("tmg_employees_aft")
public class TmgEmployeesAftDO implements Serializable {
...
private static final long serialVersionUID=1L;
         ...
         * tem_ccustomerid
         */
    @TableId(value="tem_ccustomerid",type = IdType.INPUT)

...
@TableName("hist_designation_aft")
public class HistDesignationAftDO implements Serializable {
...
private static final long serialVersionUID=1L;
         ...
         * hd_id
         */
        @TableId(value="hd_id",type = IdType.INPUT)
        private Long hdId;

...
/**
 * <p>
 * [勤怠]エラーチェック用・権限設定             データ開始日、終了日は親となる部署のデータ開始日、終了日とす
 * </p>
 *
 * @author Xiao Wenpeng
 * @since 2020-04-16
...
@TableName("tmg_evaluater_check")
public class TmgEvaluaterCheckDO implements Serializable {

...
/**
 * <p>
 * [勤怠]申請情報                      2007/01/31項目追加「申請日」「対象曜日：指定なし」
 * </p>
 *
 * @author Xiao Wenpeng
 * @since 2020-04-16
...
@TableName("tmg_notification")
public class TmgNotificationDO implements Serializable {
...
private static final long serialVersionUID=1L;
    ...
    @TableField("tntf_cstatusflg")
         ...
         * 申請者職員番号
         */
                @TableId(value = "tntf_calteremployeeid", type = IdType.AUTO)

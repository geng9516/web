...
@TableName("tmg_bak_employee_attribute")
public class TmgBakEmployeeAttributeDO implements Serializable {
...
private static final long serialVersionUID=1L;
         ...
         * 作成日
         */
    @TableField("tes_dcreate")
        private Date tesDcreate;

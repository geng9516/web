...
@TableName("tmg_bak_mgd_excludecond4thw")
public class TmgBakMgdExcludecond4thwDO implements Serializable {
...
private static final long serialVersionUID=1L;
         ...
         * idカラム
         */
                @TableId(value = "mgd_id", type = IdType.AUTO)
                private Long mgdId;
